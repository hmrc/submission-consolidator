...
object AppDependencies {
  ...
  val test = Seq(
    ...
    "com.typesafe.akka"      %% "akka-slf4j"                % "2.6.20" % Test,
    "com.typesafe.akka"      %% "akka-protobuf-v3"          % "2.6.20" % Test,
    "com.typesafe.akka"      %% "akka-serialization-jackson"% "2.6.20" % Test,
    "com.typesafe.akka"      %% "akka-stream"               % "2.6.20" % Test,
    "com.typesafe.akka"      %% "akka-actor-typed"          % "2.6.20" % Test,
